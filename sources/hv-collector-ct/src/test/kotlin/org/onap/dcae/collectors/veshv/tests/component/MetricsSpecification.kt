...
private fun vesHvWithNoOpSink(collectorConfiguration: CollectorConfiguration = basicConfiguration): Sut {
    val sut = Sut(NoOpSink())
    sut.configurationProvider.updateConfiguration(collectorConfiguration)
    return sut
}
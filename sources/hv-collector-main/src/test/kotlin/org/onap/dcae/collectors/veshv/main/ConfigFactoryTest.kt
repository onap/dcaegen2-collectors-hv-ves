    ...
    describe("A configuration loader utility") {
        ...
        describe("complete file loading") {
            it("loads actual file") {
                ...
                val security = config.security.orNull() as PartialConfiguration.PartialSecurityConfig
                ...
                val cbs = config.cbs.orNull() as PartialConfiguration.PartialCbsConfig
                ...
                assertThat(config.server.nonEmpty()).isTrue()
                val server = config.server.orNull() as PartialConfiguration.PartialServerConfig
                server.run {

    ...
    describe("Message validator") {
        ...
        on("ves hv message including header with fully initialized fields") {
            ...
            it("should accept message with fully initialized message header") {
                ...
                with(cut) {
                    assertThat(validateProtobufMessage(vesMessage).isRight()).describedAs("message validation result")
                        .isTrue()
                }
            }
            ...
            it("should not accept message with default header") {
                ...
                with(cut) {
                    validateProtobufMessage(vesMessage).fold({
                        ...
                        assertThat(containsAllErrorMessages).describedAs("message validation result").isTrue()
                    }, {
                        fail()
                    })
                }
        ...
        priorityTestCases.forEach { value, expectedResult ->
            on("ves hv message including header with priority $value") {
                ...
                it("should resolve validation result") {
                    with(cut) {
                        assertThat(validateProtobufMessage(vesMessage).isRight()).describedAs("message validation results")
            ...
            it("should not accept message header") {
                ...
                with(cut) {
                    validateProtobufMessage(vesMessage).fold({
                        ...
                        assertThat(failMessages.contains("vesEventListenerVersion mismatch")).describedAs("message validation result").isTrue()
                    },{
                        fail()
                    })
                }

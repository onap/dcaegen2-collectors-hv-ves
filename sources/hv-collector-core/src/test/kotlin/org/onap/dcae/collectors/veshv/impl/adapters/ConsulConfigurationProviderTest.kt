...
internal object ConfigurationProviderImplTest : Spek({
    ...
    describe("Configuration provider") {
        ...
        given("configuration is never in cbs") {
            val consulConfigProvider = constructConsulConfigProvider(cbsClientMock, healthStateProvider)
...
private fun constructConsulConfigProvider(cbsClientMono: Mono<CbsClient>,

...
import org.onap.dcae.collectors.veshv.impl.adapters.kafka.KafkaSinkForClientCreator
...
object AdapterFactory {
    fun sinkCreatorFactory(dummyMode: Boolean,
                           kafkaConfig: KafkaConfiguration): SinkForClientCreator =
            if (dummyMode)
                LoggingSinkForClientCreator()
            else
                KafkaSinkForClientCreator(kafkaConfig)

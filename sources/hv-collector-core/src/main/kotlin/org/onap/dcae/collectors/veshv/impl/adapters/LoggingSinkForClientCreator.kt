 ...
 * @since June 2018
 */
internal class LoggingSinkForClientCreator : SinkForClientCreator {
    ...
    override fun invoke(ctx: ClientContext): Sink {
        return object : Sink {
            ...
            override fun send(messages: Flux<RoutedMessage>): Flux<ConsumedMessage> =
                    messages.doOnNext(this::logMessage).map(::SentMessage)
    ...
    companion object {
        ...
        private val logger = Logger(LoggingSinkForClientCreator::class)
    }
}

 ...
 * @since May 2018
 */
internal class CbsConfigurationProvider(private val hvVesCbsClient: HvVesCbsClient,
    ...
    constructor(hvVesCbsClient: HvVesCbsClient,
            ...
            this(
                    ...
                    Retry.any<Any>()
                            ...
                            .fixedBackoff(cbsConfiguration.requestInterval)
    ...
    operator fun invoke(): Flux<PartialConfiguration> =
            hvVesCbsClient.updates(CbsRequests.getConfiguration(RequestDiagnosticContext.create()),

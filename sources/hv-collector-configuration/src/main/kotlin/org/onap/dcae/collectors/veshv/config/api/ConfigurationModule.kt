...
class ConfigurationModule internal constructor(private val configStateListener: ConfigurationStateListener,
    ...
    fun hvVesConfigurationUpdates(args: Array<String>,
            ...
            Mono.just(cmd.getConfigurationFile(args))
                    ...
                    .flatMapMany { basePartialConfig ->
                        val hvVesCbsClient = hvVesCbsClient(basePartialConfig)
    ...
    private fun hvVesCbsClient(basePartialConfig: PartialConfiguration): HvVesCbsClient {
        return HvVesCbsClient(
                cbsClient,
                configStateListener,
    ...
    private fun cbsConfigurationProvider(hvVesCbsClient: HvVesCbsClient,

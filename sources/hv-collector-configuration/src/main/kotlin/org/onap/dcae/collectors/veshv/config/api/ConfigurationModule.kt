...
class ConfigurationModule {
    ...
    private lateinit var cbsClient: HvVesCbsClient
    ...
    fun hvVesConfigurationUpdates(args: Array<String>,
        ...
        prepareHvVesCbsClient(configStateListener, mdc)
        return Mono.just(cmd.getConfigurationFile(args))
                ...
                .flatMapMany { basePartialConfig ->
                    cbsConfigurationProvider(basePartialConfig, configStateListener, mdc)
                            ...
                            .doOnNext {
                                cbsClient.updateCurrentCbsInterval(it.cbs.requestInterval)
                            }
                }
    }

    private fun prepareHvVesCbsClient(configStateListener: ConfigurationStateListener, mdc: MappedDiagnosticContext) {
        cbsClient = HvVesCbsClient(

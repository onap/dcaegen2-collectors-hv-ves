...
class ConfigurationModule {
    ...
    fun hvVesConfigurationUpdates(args: Array<String>,
        ...
        prepareCustomCbsClient(configStateListener, mdc)
    ...
    private fun prepareCustomCbsClient(configStateListener: ConfigurationStateListener, mdc: MappedDiagnosticContext) {

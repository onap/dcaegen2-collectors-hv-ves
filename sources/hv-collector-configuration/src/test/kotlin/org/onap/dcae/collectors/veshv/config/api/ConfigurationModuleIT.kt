    ...
    describe("configuration module") {
        ...
        given("sample configuration in file: $configPath") {
            ...
            on("configuration changes in Config Binding Service") {
                ...
                it("should wait $firstRequestDelayFromFile s as specified in configuration file and then" +
                        " provide configurations with interval provided in fetched from CBS configurations") {
                    StepVerifier
                            .withVirtualTime {

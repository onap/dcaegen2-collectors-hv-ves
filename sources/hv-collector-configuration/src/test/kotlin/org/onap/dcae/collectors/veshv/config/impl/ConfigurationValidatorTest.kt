            ...
            it("should create validated configuration") {
                ...
                result.fold(
                        ...
                        },
                        {
                            ...
                            assertThat(it.sslDisable).isEqualTo(Some(false))
                            assertThat(it.keyStoreFile).isEqualTo(Some(KEYSTORE))
                            assertThat(it.keyStorePasswordFile).isEqualTo(Some(KEYSTORE_PASSWORD))
                            assertThat(it.trustStoreFile).isEqualTo(Some(TRUSTSTORE))
                            assertThat(it.trustStorePasswordFile).isEqualTo(Some(TRUSTSTORE_PASSWORD))
            ...
            it("should return validated configuration regardless of security keys presence") {
                ...
                result.fold(
                        ...
                        },
                        {
                            ...
                            assertThat(it.keyStorePasswordFile).isEqualTo(None)
                            assertThat(it.trustStoreFile).isEqualTo(None)
                            assertThat(it.trustStorePasswordFile).isEqualTo(Some(""))

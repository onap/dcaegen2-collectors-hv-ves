...
private val initialRequestInterval = Duration.ofSeconds(1)
private val updatedRequestInterval = Duration.ofSeconds(10)
private val firstRequestDelay = Duration.ofSeconds(1)
...
private val request2 = ImmutableCbsRequest.builder().requestPath(request)
        .diagnosticContext(diagnosticContext2).build()
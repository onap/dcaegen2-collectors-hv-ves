...
import org.onap.dcae.collectors.veshv.ves.message.generator.api.vesevent.VesEventType.FIXED_PAYLOAD
    ...
    private fun validateMessageParams(params: MessageParameters): VesEventParameters =
            if (params !is VesEventParameters)
                throw IllegalArgumentException(
                        "Only VesEvent-related message types can be validated. " +

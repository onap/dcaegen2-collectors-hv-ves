...
import org.onap.dcae.collectors.veshv.ves.message.generator.api.wireframe.WireFrameType.INVALID_WIRE_FRAME
    ...
    private fun createMessage(messageType: WireFrameType): WireFrameMessage =
            when (messageType) {
                INVALID_WIRE_FRAME -> {
                    ...
                    // we do not care about the payload when we validate wire frame anyway
                    // so i thought that we can just use default one

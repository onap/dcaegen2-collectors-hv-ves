...
function usage() {
    ...
    echo "Remote host invocation ( Kubernetes slave IP given with default K8S NodePort for HV-VES service ):"
    echo "./start-simulation.sh --xnf-logs-directory=/tmp/xnf-simulation 10.183.36.78 30222 5 100 5"
    exit 1
}
